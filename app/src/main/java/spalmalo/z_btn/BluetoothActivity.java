...
public class BluetoothActivity extends Activity {
    ...
    private static String address = "38:2C:4A:05:65:6F";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txtArduino = (TextView) findViewById(R.id.text);
        ...
        btnOn.setOnClickListener(new View.OnClickListener() {        // определяем обработчик при нажатии на кнопку
